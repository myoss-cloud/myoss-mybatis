...
import com.github.myoss.phoenix.mybatis.test.integration.h2.H2DataBaseIntTest.SequenceCustomizer;
...
@Data
@SequenceGenerator(strategy = GenerationType.SEQUENCE_KEY, sequenceKey = @SequenceKey(sequenceClass = SequenceCustomizer.class, sequenceBeanName = "seqUserLog", sequenceName = "sequenceUserLog", keyProperty = { "id" }, keyColumn = { "id" }, order = Order.BEFORE))
